...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-1/4 left-1/3 w-80 h-80 bg-secondary-300 dark:bg-secondary-800 rounded-full filter blur-3xl opacity-20 dark:opacity-20 animate-pulse"
